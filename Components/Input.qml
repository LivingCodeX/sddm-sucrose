...
Column {
        ...
        ComboBox {
            ...
            delegate: ItemDelegate {
                ...
                contentItem: Text {
                    ...
                    color: selectUser.highlightedIndex === index ? config.AccentColor : config.MainColor
                    verticalAlignment: Text.AlignVCenter
                    horizontalAlignment: Text.AlignHCenter
                }
                highlighted: parent.highlightedIndex === index
                background: Rectangle {
                    color: selectUser.highlightedIndex === index ? config.BackgroundAccentColor : "transparent"
                }
            }
    ...
    Item {
        ...
        Label {
            id: errorMessage
            width: parent.width
            text: failed ? config.TranslateLoginFailed || textConstants.loginFailed + "!" : keyboard.capsLock ? config.TranslateCapslockWarning : null
            horizontalAlignment: Text.AlignHCenter
            font.pointSize: root.font.pointSize * 0.8
            font.italic: true
            color: root.palette.text
    ...
    Item {
        ...
        Button {
            ...
            contentItem: Text {
                ...
                horizontalAlignment: Text.AlignHCenter
                verticalAlignment: Text.AlignVCenter
                opacity: config.RevealLoginButton == "true" ? 0.0 : 1.0
            }

            background: Rectangle {
                id: buttonBackground
                color: Qt.darker(config.AccentColor, 1.5)
                opacity: config.RevealLoginButton == "true" ? 0.0 : 0.2
                radius: config.RoundCorners || 0
            }
            ...
            states: [
                State {
                    ...
                    PropertyChanges {
                        ...
                        color: Qt.darker(config.BackgroundAccentColor, 1.1)
                        opacity: 1
                    }
                    PropertyChanges {
                ...
                State {
                    ...
                    PropertyChanges {
                        target: buttonBackground
                        color: config.BackgroundAccentColor
                        opacity: 1
                    }
                    PropertyChanges {
                        target: loginButton.contentItem
